# Desafio
# O calendário escolar está passando bem rápido, devido a isso, as professoras de uma escola
# estão com dificuldade para calcular as notas dos alunos. Visando em resolver a situação, a
# diretora da escola contratou você para desenvolver um programa que leia as notas da primeira
# e da segunda avaliação de um aluno. Calcule e imprima a média semestral.
#
# O programa só aceitará notas válidas (uma nota válida deve pertencer ao intervalo [0,10]).
# Cada nota deve ser validada separadamente.
#
# No final deve ser impressa a mensagem “novo calculo (1-sim 2-nao)”, solicitando as professoras
# que informe um código (1 ou 2) indicando se ele deseja ou não executar o algoritmo novamente,
